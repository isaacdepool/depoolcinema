...
module.exports = __webpack_require__(/*! C:\Users\isac\Desktop\IsaacDepool\depool\src\main.ts */"zUnb");
...
const environment = {
    production: false,
    baseUrl: 'https://depool-cinema.glitch.me/api' //prd
...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | cinema-cinema-module */ "cinema-cinema-module").then(__webpack_require__.bind(null, /*! ./cinema/cinema.module */ "ZTHn")).then(m => m.CinemaModule)
    },
    {
        path: '**',
        redirectTo: ''
